...
<?php include_once('includes/header.php');?>
        <center><h1 style="font-size: 45px;">Recover your Password</h1></center>
...
<!--Email Id-->
                        ...
                        <input style="font-size: 15px;" class="brd-rd3" type="email" placeholder="Registered Email id" name="email" id="email" required="true">
                                                        </div>


<!--Mobile Number-->
                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                        <input style="font-size: 15px;" class="brd-rd3" type="text" placeholder="Registered Mobile Number" name="contactno" maxlength="10" pattern="[0-9]{10}" required="true">
                                                        </div>
