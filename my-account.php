...
<html lang="en">
   <head>
      ...
      <title>Gadget.Shop | My Account</title>
...
popUpWin = open(URLStr,'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+600+',height='+600+',left='+left+', top='+top+',screenX='+left+',screenY='+top+'');
   ...
   <body itemscope>
      ...
      <center><h1 style="font-size: 45px;">My Account</h1></center>
              ...
              { ?>  
                        ...
                        <div class="order-item brd-rd5">
                           <div class="order-thumb brd-rd5">
                              <a href="#" title="" itemprop="url"><img src="assets/images/order2.png" alt="order-img1.jpg" itemprop="image"></a>
                        
                           </div>
                           <div class="order-info">
                              <span class="red-clr"><b>Order Date :</b> <?php echo $row['OrderTime']?></span>
                              <h4><a href="#" title="" itemprop="url">Order # <?php echo $row['Ordernumber'];?></a></h4>
...
echo $status;
                                     ...
                                     <li style="font-size:16px;"> <a href="javascript:void(0);" onClick="popUpWindow('trackorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Track order"></a></li>
                                                                    </ul>
                                                </div>
                                             </div>
                                         <?php } } else {?>
